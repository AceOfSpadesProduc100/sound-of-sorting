...
WMain_wxg::WMain_wxg(wxWindow *parent, int id, const wxString &title, const wxPoint &pos, const wxSize &size, long /* style */) : wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    const wxString *inputSound_choices = NULL;
    inputSound = new wxChoice(splitter_0_pane_2, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, inputSound_choices, 0);
...
void WMain_wxg::do_layout()
{
    ...
    wxStaticText *labelSounds = new wxStaticText(splitter_0_pane_2, wxID_ANY, _("Sound: "));
    grid_sizer_1->Add(labelSounds, 0, wxTOP | wxBOTTOM | wxALIGN_CENTER_VERTICAL, 4);
    grid_sizer_1->Add(inputSound, 0, wxTOP | wxBOTTOM | wxEXPAND | wxALIGN_CENTER_VERTICAL, 4);
